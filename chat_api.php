...
// --- IDENTIFY THE USER ---
// Use logged-in email, OR generate a persistent Guest Email
if (isset($_SESSION['email']) && !empty($_SESSION['email'])) {
    ...
    if (!isset($_SESSION['guest_chat_email'])) {
        $_SESSION['guest_chat_email'] = 'guest_' . substr(session_id(), 0, 6) . '@example.com';
...
// --- 2. USER FETCHES MESSAGES (To see Admin Reply) ---
